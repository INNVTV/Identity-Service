        ...
        public async Task<BaseResponse> Handle(InviteUserCommand request, CancellationToken cancellationToken)
        {
            ...
            if (result.StatusCode == System.Net.HttpStatusCode.Created)
            {
                ...
                var emailMessage = new EmailMessage
                {
                    ...
                    HtmlContent = String.Concat("You have been invited to ", _coreConfiguration.Application.Name, ".</br></br> Please accept your invite and create your identity by following the instructions at the link below.<br/><br/>" + Common.Emails.EmailButtonGenerator.Generate(invitationLink, "Accept Invitation", 140)),
                };
